...
namespace GreenTwinUpdater.DigitalTwins
{
    public class DigitalTwinsManager
    {
        private static readonly string adtInstanceUrl = "DTBGreenTwin.api.jpe.digitaltwins.azure.net";
        ...
        public async Task UpdateDigitalTwinPropertyAsync(string twinId, string propertyName, object propertyValue)
        {
        ...
        public async Task QueryDigitalTwinsAsync(string query, QueryResult onQueryResult)
        {
